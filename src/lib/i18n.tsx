...
const dict = {
  ...
  coursePageSettings: { ar: "إعدادات صفحة المادة", en: "Course page settings" },
  coursePageSettingsHint: {
    ar: "رفعي سيلابس جديد، أو رتّبي أقسام هذي الصفحة حسب ما يريحك.",
    en: "Upload a fresh syllabus, or reorder this page's sections however suits you.",
  },
  sectionOrder: { ar: "ترتيب الأقسام", en: "Section order" },
  resetOrder: { ar: "إعادة التعيين", en: "Reset" },
  sectionOrderReset: { ar: "رجع الترتيب الافتراضي", en: "Order reset to default" },
  moveUp: { ar: "تحريك لأعلى", en: "Move up" },
  moveDown: { ar: "تحريك لأسفل", en: "Move down" },
  sectionGrades: { ar: "توزيع الدرجات", en: "Grade distribution" },
  sectionMaterials: { ar: "ملفات هذي المادة", en: "This course's files" },
  sectionCalendar: { ar: "تقويم المادة", en: "Course calendar" },
  sectionChecklist: { ar: "قائمة المهام", en: "Checklist" },
