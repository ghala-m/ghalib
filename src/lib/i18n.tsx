...
const dict = {
  ...
  resetAccountHint: {
    ...
    en: "Deletes all your courses, terms, events, chats and files and returns the account to its first sign-in state. This cannot be undone.",
  },
  resetConfirmTitle: { ar: "متأكدة من إعادة التعيين؟", en: "Reset everything?" },
  resetTypeHint: { ar: "اكتبي RESET للتأكيد", en: "Type RESET to confirm" },
  resetting: { ar: "جارٍ إعادة التعيين…", en: "Resetting…" },
  resetDone: { ar: "تمت إعادة تعيين الحساب", en: "Account reset" },
  ...
  customCombo: { ar: "توليفتك الخاصة", en: "Your own combination" },
  customComboHint: {
    ar: "اختر لون الخلفية ولون الأزرار بنفسك — بدل ما تختار من التوليفات الجاهزة.",
    en: "Pick the background and button colours yourself — instead of choosing from the ready-made combinations.",
  },
  customComboBg: { ar: "الخلفية", en: "Background" },
  customComboAccent: { ar: "الأزرار", en: "Buttons" },
  customComboReset: { ar: "إرجاع الخلفية الافتراضية", en: "Reset background to default" },
  ...
  prep: { ar: "تمهيدي (بدون كردت)", en: "Prep (no credit)" },
  ...
  editTerm: { ar: "تعديل الفصل الحالي", en: "Edit current term" },
  editTermHint: {
    ar: "عدّل بيانات الفصل، أضف أو أزل مواد منه، وأدر أحداث الكالندر الجامعي.",
    en: "Edit term details, add or remove courses, and manage university calendar events.",
  },
  termUpdated: { ar: "تم تحديث الفصل", en: "Term updated" },
  termCourses: { ar: "مواد الفصل", en: "Term courses" },
  removeFromTerm: { ar: "إزالة من الفصل", en: "Remove from term" },
  removeFromTermHint: {
    ar: "تبقى بيانات المادة محفوظة وتتحول إلى «خطة مستقبلية».",
    en: "Course data is kept and it moves back to “future plan”.",
  },
  addToTerm: { ar: "إضافة للفصل", en: "Add to term" },
  addedToTerm: { ar: "أُضيفت المادة إلى الفصل", en: "Course added to the term" },
  ...
  eventTypeBreak: { ar: "عطلة/راحة", en: "Break" },
  eventTypeOther: { ar: "أخرى", en: "Other" },
  ...
  roadmapTitle: { ar: "خارطة التخرج", en: "Graduation roadmap" },
  roadmapHint: {
    ar: "وش باقي عليك بالضبط، مقسّم حسب نوع المتطلب، ومتى تتخرج بالتقريب.",
    en: "What's left, broken down by requirement type, and roughly when you'll graduate.",
  },
  roadmapEmpty: {
    ar: "أضف موادك (الحالية والمستقبلية) عشان نقدر نحسب لك خارطة التخرج.",
    en: "Add your courses (current and future) so we can build your roadmap.",
  },
  roadmapCreditsSoFar: { ar: "الوحدات المنجزة", en: "Credits earned" },
  roadmapTermsLeft: { ar: "باقي لك {n} فصل تقريبًا", en: "About {n} more terms" },
  roadmapEstimatedGrad: { ar: "التخرج المتوقع:", en: "Estimated graduation:" },
  roadmapDone: { ar: "أنجزت كل متطلباتك! 🎉", en: "You've completed every requirement! 🎉" },
  roadmapPaceLabel: { ar: "وتيرتك:", en: "Your pace:" },
  roadmapPaceHint: {
    ar: "وحدة بكل فصل — عدّلها لتقدير أدق",
    en: "per term — adjust for a more accurate estimate",
  },
  roadmapCategoryDone: { ar: "خلّصت هذا القسم بالكامل ✓", en: "This requirement is fully done ✓" },
  ...
  gpaHistoryEmptyTermsHint: {
    ar: "فصول ما فيها ولا مادة مسجلة — غالبًا انحطت بالغلط. تقدر تحذفها.",
    en: "Terms with no courses attached — usually created by mistake. You can delete them.",
  },
  gpaHistoryEmptyTermDeleted: { ar: "انحذف الفصل.", en: "Term deleted." },
  gpaHistoryLinkOrphans: {
    ar: "اربط مواد بدون فصل بهذا الفصل (اختياري):",
    en: "Link courses with no term to this one (optional):",
  },
  gpaHistoryUnlabeled: {
